      ...
      <div className={styles.cardRow}>
        ...
        <div className={`card ${styles.achievementCard}`}>
          ...
          <div className="card-body">
            <h3 className="card-title">Micromouse Competition</h3>
            <p className="card-text">2nd Runner Up, IIT Bombay, 2022</p>
            <a href="https://drive.google.com/drive/folders/1ZvO1aXkVKVZ2cgqXInEUFy3mumFhQnzX" target='blank'>
        ...
        <div className={`card ${styles.achievementCard}`}>
          <img src="./micromouse2.jpg" className="card-img-top" alt="..." width={300} height={250} />
          <div className="card-body">
          <h3 className="card-title">Rowboatics Competition</h3>
